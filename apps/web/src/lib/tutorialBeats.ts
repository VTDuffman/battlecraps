...
export const TUTORIAL_BEATS: TutorialBeat[] = [
  ...
  },
  {
    ...
    salText: `Every floor has a boss. Nine of them, each one worse than the last. The Foreman takes his cut. Sarge jacks the minimums. Mme. Le Prix shuts your crew down. And that's just the first three floors. Know who you're facing.`,
    advanceMode: 'tap',
