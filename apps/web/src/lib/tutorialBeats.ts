...
export const TUTORIAL_BEATS: TutorialBeat[] = [
...

  {
    ...
    salText: `See that target up top? That's your marker. Every chip you win counts toward it. Clear the marker and you move up a floor. Five floors, fifteen markers. That's the gauntlet.`,
    advanceMode: 'tap',
    advanceLabel: 'Got it.',
  },
  {
  ...
  },
  {
    ...
    salText: `Every floor has a boss. The Foreman takes a cut. Sarge jacks the minimums. Mme. Le Prix silences your crew. The Executive drops 4s. The Hierophant seizes tribute on every seven-out. Know who you're facing.`,
    advanceMode: 'tap',
