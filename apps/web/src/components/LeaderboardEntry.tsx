  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Name */}
        <span
          className="font-pixel text-[13.5px] flex-1 truncate"
        ...
        <span className="font-mono text-[13.5px]" style={{ color: theme.accentPrimary }}>
        ...
        {showMarker ? (
          <span
            className="font-pixel text-[10.5px] px-1.5 py-0.5 rounded"
            style={{ background: `${theme.accentDim}20`, color: `${theme.accentPrimary}70` }}
          >
            F{floorNum} MKR {markerInFloor}
          </span>
        ) : entry.didWinRun ? (
          <span className="font-pixel text-[10.5px]" style={{ color: theme.accentBright }}>★</span>
        ) : null}
      ...
      {expanded && (
        <div className="px-3 pb-3 border-t" style={{ borderColor: `${theme.accentDim}20` }}>
          <p
            className="font-pixel text-[10.5px] tracking-widest mt-2 mb-1.5"
