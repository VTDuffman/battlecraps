    ...
    >
      ...
      >
        {boss.entryLines.map((line, i) => (
          <p
            key={i}
            className="font-mono text-[13.5px] text-center leading-relaxed italic"
        ...
        />
        <p className="mt-2 font-pixel text-[7.5px] text-center tracking-wide" style={{ color: `${theme.bossTextColor}66` }}>
          — {boss.name}
        </p>
      </div>
      ...
      <p className="font-pixel text-[7.5px] tracking-wide text-center px-8" style={{ color: `${theme.bossTextColor}4d` }}>
