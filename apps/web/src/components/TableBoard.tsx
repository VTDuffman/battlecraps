    ...
    >
      ...
      <div className="relative flex justify-between items-center w-full p-2 z-20 bg-black/60 border-b border-white/10">
        ...
        <div className="flex items-center gap-1">
          ...
          {onReturnToTitle && (
            returnConfirm ? (
              <>
                <span className="font-pixel text-[9.375px] text-red-400/70 whitespace-nowrap">RETURN TO TITLE SCREEN?</span>
                <button
                  type="button"
                  onClick={() => { setReturnConfirm(false); onReturnToTitle(); }}
                  className="px-2 h-7 flex items-center rounded font-pixel text-[10.9px] bg-red-900/70 text-red-300 border border-red-700/50 hover:bg-red-800/90 transition-colors"
                ...
                <button
                  ...
                  className="px-2 h-7 flex items-center rounded font-pixel text-[10.9px] bg-black/80 text-gold border border-white/10 hover:text-gold-bright transition-colors shadow-md"
                  aria-label="Cancel"
                >
                  NO
                </button>
              ...
              >
                ...
                <span className="font-pixel text-[10.9px] tracking-widest">TITLE SCREEN</span>
              </button>
            )
          )}
          ...
          {onNewRun && (
            abandonConfirm ? (
              <>
                <span className="font-pixel text-[9.375px] text-red-400/70">END?</span>
                <button
                  type="button"
              ...
              <button
                ...
                disabled={isRolling}
                className="px-1.5 h-7 flex items-center rounded font-pixel text-[10.9px] bg-black/80 text-gold hover:text-gold-bright disabled:opacity-20 transition-colors tracking-widest shadow-md"
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-1.5 py-0.5 rounded bg-black/90 border border-white/10 font-pixel text-[9.375px] text-gold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
              SUBMIT FEEDBACK
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            >
              <span className="font-pixel text-[17.5px] leading-none">?</span>
            </button>
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 px-1.5 py-0.5 rounded bg-black/90 border border-white/10 font-pixel text-[9.375px] text-gold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
              HELP
            </div>
      ...
      >
        ...
        <div className="flex items-center gap-2" style={{ marginBottom: 'clamp(2px,0.3dvh,8px)' }}>
          ...
          <span className="font-pixel text-[9.375px] tracking-widest" style={{ color: theme.accentPrimary }}>
            CREW
          </span>
          <div className="h-px flex-1" style={{ backgroundColor: theme.borderLow }} />
        </div>
    ...
    <div className="w-full" style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(4px,0.5dvh,8px)' }}>
      ...
      <div className="grid grid-cols-[1fr_2fr_1fr] gap-1 px-1" data-tutorial-zone="bankroll-zone">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Tagline */}
          <div className="font-pixel text-[7.8px] text-gold/40 tracking-[0.4em] mt-0.5">
            · CASINO GAUNTLET ·
          </div>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <div className="text-center" data-tutorial-zone="hype-meter">
            ...
            <div className="flex items-center justify-center gap-1.5">
              ...
              {/* Numeric readout */}
              <div className={`font-pixel text-[17.5px] ${hypeColour} ${hypeAnim}`}>
                {hypeStr}
              </div>
            </div>
          </div>
      ...
      <div className="relative w-full">
        ...
        <div className="flex items-center gap-2 justify-center mt-3" data-tutorial-zone="game-status">
          ...
          <span className="font-pixel text-[10.9px]" style={{ color: isNullSpace ? 'rgba(0,0,0,0.40)' : 'rgba(255,255,255,0.30)' }}>
        ...
        {targetMet && (
          <button
            ...
            className="
              ...
              h-10
              rounded font-pixel text-[10.9px] tracking-widest
...
const ChipRail: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="text-center font-pixel text-[10.9px]" style={{ color: isNullSpace ? 'rgba(0,0,0,0.40)' : 'rgba(255,255,255,0.30)', marginBottom: 'clamp(2px,0.3dvh,8px)' }}>
