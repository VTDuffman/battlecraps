...
export const TUTORIAL_BEATS: TutorialBeat[] = [
  ...
  },
  {
    ...
    path: 'A',
    spotlight: 'game-status',
    salText: `HARD EIGHT! Look at that bankroll jump. You just cleared your first marker, kid.`,
    advanceMode: 'tap',
    advanceLabel: 'Got it.',
  },
  {
...

  {
    ...
    salText: `See that target up top? That's your marker. Every chip you win counts toward it. Clear the marker and you move up a floor. Nine floors, twenty-seven markers. That's the gauntlet.`,
    advanceMode: 'tap',
    advanceLabel: 'Got it.',
  },
  {
    ...
    salText: `That's your Hype multiplier. Every time you hit a point, it ticks up. String hits together and your payouts explode. Seven-out and it resets. Clear a marker and it resets too — hype is earned fresh on every floor.`,
    advanceMode: 'tap',
    advanceLabel: 'Got it.',
  },
  {
  ...
  },
  {
    ...
    salText: `Every floor has a boss. Nine of them, each one worse than the last. The Foreman takes his cut. Sarge jacks the minimums. Mme. Le Prix enchants one crew member per come-out — they sit out until the point resolves. And that's just the first three floors. Know who you're facing.`,
    advanceMode: 'tap',
