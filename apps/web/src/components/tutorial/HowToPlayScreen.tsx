  ...
  <div className="flex flex-col h-full">
    ...
    <div className="flex-none px-5 pt-5 pb-3 border-b border-white/10 flex items-center gap-3">
      <button
        type="button"
        onClick={onBack}
        className="font-pixel text-r-8 text-white/40 hover:text-white/70 transition-colors active:scale-95"
        aria-label="Back to lobby"
      >
        ← BACK
      </button>
      <div
        className="flex-1 font-pixel text-r-10 text-center tracking-widest"
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="font-mono text-r-8 text-white/40 mt-0.5">
                {section.subtitle}
              </div>
            </div>
            <span
