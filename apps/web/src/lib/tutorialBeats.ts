...
export const TUTORIAL_BEATS: TutorialBeat[] = [
...

  {
    ...
    salText: `See that target up top? That's your marker. Every chip you win counts toward it. Clear the marker and you move up a floor. Four floors, twelve markers. That's the gauntlet.`,
    advanceMode: 'tap',
    advanceLabel: 'Got it.',
  },
  {
  ...
  },
  {
    ...
    salText: `Every floor has a boss. The Foreman takes 20% off every payout. Past him: Sarge jacks the minimums. Mme. Le Prix silences your crew. The Executive ends it with a single 4. Know who you're facing.`,
    advanceMode: 'tap',
